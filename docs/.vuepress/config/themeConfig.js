...
module.exports = {
    ...
    // navTitle: 'Jumbo',
    logo: "https://static.zhmbo.cn/img/20201011161451.png", // 导航栏logo
    ...
    bodyBgImg: [
      "https://static.zhmbo.cn/img/love5201314.jpg",
    ...
    author: {
      name: "Jumbo", // 必需
      link: "https://github.com/itzhangbao", // 可选的
    },

    // 博主信息，显示在首页侧边栏
    blogger: {
      avatar: "https://static.zhmbo.cn/img/20200919111632.png",
      name: "@jumbo",
    ...
    //   copyrightInfo: 'Jumbo | <a href="https://github.com/itzhangbao/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
